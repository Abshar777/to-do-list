...
function button({ icon, name, secIcon,border,count,active }) {
    return (
        <div style={{ transition: 'all ease 0.3s' }} className={`cursor-pointer flex w-full p-2 hover:bg-zinc-800 ease-in duration-100 transition-all transi items-center justify-between ${border&&'border-[1px]'} ${active&&'bg-zinc-800'} border-zinc-800 rounded-md`}>
